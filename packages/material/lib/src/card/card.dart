import 'package:material/material.dart' hide CardTheme, CardThemeData;
import 'package:material/src/card/card_theme.dart';
...
class Card extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // TODO: bad API, figure out a new interface to use for button styles as well
    final CardThemeData cardTheme = switch (_variant) {
      _CardVariant.elevated => ElevatedCardTheme.of(context),
      _CardVariant.filled => FilledCardTheme.of(context),
      _CardVariant.outlined => OutlinedCardTheme.of(context),
    };
