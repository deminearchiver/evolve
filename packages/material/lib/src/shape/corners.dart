  ...
  BorderRadius toBorderRadius(Rect rect) {
    ...
    if (topLeft.x == null) {
      if (topRight.x == null) {
        ...
        topLeftX = clampDouble(width - topRightX, 0.0, shortestSide);
      }
    } else {
      topLeftX = topLeft.x!;
      topRightX =
          topRight.x ?? clampDouble(width - topLeftX, 0.0, shortestSide);
    }
    ...
    if (topRight.y == null) {
      if (bottomRight.y == null) {
        ...
        topRightY = clampDouble(height - bottomRightY, 0.0, shortestSide);
      }
    } else {
      topRightY = topRight.y!;
      bottomRightY =
          bottomRight.y ?? clampDouble(height - topRightY, 0.0, shortestSide);
    }
    ...
    if (bottomRight.x == null) {
      if (bottomLeft.x == null) {
        ...
        bottomRightX = clampDouble(width - bottomLeftX, 0.0, shortestSide);
      }
    } else {
      bottomRightX = bottomRight.x!;
      bottomLeftX =
          bottomLeft.x ?? clampDouble(width - bottomRightX, 0.0, shortestSide);
    }
    ...
    if (bottomLeft.y == null) {
      if (topLeft.y == null) {
        ...
        topLeftY = topLeft.y!;
        bottomLeftY = clampDouble(height - topLeftY, 0.0, shortestSide);
      }
    } else {
      bottomLeftY = bottomLeft.y!;
      topLeftY =
          topLeft.y ?? clampDouble(height - bottomLeftY, 0.0, shortestSide);
    }
