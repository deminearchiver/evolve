...
///
/// See also:
///  * [Button.elevated], a filled button whose material elevates when pressed.
///  * [Button.filled], a filled button that doesn't elevate when pressed.
///  * [Button.filledTonal], a filled button variant that uses a secondary fill color.
///  * [Button.outlined], a button with an outlined border and no fill color.
///  * [Button.text], a button with no outline or fill color.
...
class _ButtonStyleState extends State<ButtonStyleButton>
  ...
  Widget build(BuildContext context) {
    ...
    if (resolvedAnimationDuration! > Duration.zero &&
        ...
        backgroundColor!.toARGB32() != resolvedBackgroundColor!.toARGB32() &&
        backgroundColor!.a == 1 &&
