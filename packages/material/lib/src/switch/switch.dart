...
//     final Set<WidgetState> activePressedStates =
//         activeStates..add(WidgetState.pressed);
...
//     final Set<WidgetState> inactivePressedStates =
//         inactiveStates..add(WidgetState.pressed);
...
//               end: transitionalThumbSize,
//             ).chain(
//               CurveTween(curve: const Cubic(0.20, 0.00, 0.00, 1.00).flipped),
//             ),
//             weight: 72,
//           ),
//           TweenSequenceItem<Size>(
...
//               end: activeThumbSize,
//             ).chain(
//               CurveTween(curve: const Cubic(0.31, 0.00, 0.56, 1.00).flipped),
//             ),
//             weight: 11,
//           ),
//         ];
...
//   // double get activeThumbRadius => 17.6 / 2;
...
//   // double get inactiveThumbRadius => 17.0 / 2;

//   @override
//   double get pressedThumbRadius => 28.0 / 2;
//   // double get pressedThumbRadius => 17.6 / 2;
...
//   // Size get transitionalThumbSize => const Size(17.6, 17.6);
...
//   // Hand coded default based on the animation specs.
//   @override
//   double? get thumbOffset => 0;

//   @override
//   Size get switchMinSize =>
//       const Size(kMinInteractiveDimension, kMinInteractiveDimension - 8.0);
// }
