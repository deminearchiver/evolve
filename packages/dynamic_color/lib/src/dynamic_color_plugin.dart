...
abstract final class DynamicColorPlugin {
  ...
  static Future<CorePalette?> getCorePalette() =>
      dynamic_color.DynamicColorPlugin.getCorePalette();
  ...
  static Future<Color?> getAccentColor() =>
      dynamic_color.DynamicColorPlugin.getAccentColor();
}
