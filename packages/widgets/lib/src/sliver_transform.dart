...
class RenderSliverTransform extends RenderProxySliver {
  ...
  bool hitTestChildren(
    ...
    return result.addWithPaintTransform(
      ...
      crossAxisPosition: crossAxisPosition,
      hitTest:
          (result, {required crossAxisPosition, required mainAxisPosition}) =>
...
extension _SliverHitTestResultExtension on SliverHitTestResult {
  ...
  bool addWithRawTransform({
    ...
    final position = switch (axisDirection) {
      AxisDirection.up ||
    ...
    final transformedMainAxisPosition = switch (axisDirection) {
      AxisDirection.up || AxisDirection.down => transformedPosition.dy,
      AxisDirection.right || AxisDirection.left => transformedPosition.dx,
    };
    final transformedCrossAxisPosition = switch (axisDirection) {
      AxisDirection.up || AxisDirection.down => transformedPosition.dx,
      AxisDirection.right || AxisDirection.left => transformedPosition.dy,
    };
    if (transform != null) {
